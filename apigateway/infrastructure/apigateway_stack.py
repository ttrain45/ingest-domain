    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        http_api_cfn_integration_player_delete = apigatewayv2.CfnIntegration(self,
                                                                      ...
                                                                      request_parameters={
                                                                          "Source": "ingest-api",
                                                                          "DetailType": "player",
                                                                          "Detail": json.dumps({"method": "${context.httpMethod}", "id": "${request.querystring.id}"}),
                                                                          # Plan to add timestamp as key / value pair passed in
                                                                          "EventBusName": core_event_bus.event_bus_arn
                                                                      },
                                                                      payload_format_version="1.0",
        ...
        http_api_cfn_integration_read_player = apigatewayv2.CfnIntegration(self,
                                                                           ...
                                                                           integration_type="AWS_PROXY",
                                                                           integration_uri="arn:aws:apigateway:us-east-1:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-1:284369237500:function:ReadPlayer/invocations",
